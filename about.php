            ...
            <div class="container">
              <div class="row">
                <div class="col-xl-6">
                  ...
                  <h2 class="ui-title">About <span class="text-primary">AvaiCar</span></h2>
                  ...
                  <p>AvailCar.com has providing the platform to used car dealers and interested buyers & sellers to upload their cars for sale, and find used car to buy. Interested buyers can select car on AvailCar.com and contact us for physical verification of vehicles.</p> 
                ...
                <div class="col-xl-6">
                  <div class="b-bnr__second">
                    <div class="b-bnr-contacts">
                      <div class="b-bnr-contacts__info">Call Us For Booking Vehicle</div><a class="b-bnr-contacts__phone" href="tel:+17553028549"><i class="ic icon-call-end text-primary"></i> +91 <?php echo($headOfficeDetails['first_phone_no']) ?></a>
                    </div>
                  </div>
                </div>
              </div>
