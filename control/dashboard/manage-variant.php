        ...
        <main class="page-content">
            <div class="container">
                <div class="page-header">
                    <h1 class="page-header__title">Add Variant</h1>
                </div>
                        ...
                        <div class="breadcrumbs">
                            <div class="breadcrumbs__container">
                                <ol class="breadcrumbs__list">
                                    ...
                                    <li class="breadcrumbs__item active"><span class="breadcrumbs__link">Add Variant</span>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="card add-product card--content-center">
                    <div class="card__wrapper">
                        <div class="card__container">
                            <form class="add-product__form" method="POST" action="./execution/variant-exe.php">
                                    ...
                                    <div class="add-product">
                                        <div class="row row--md">
                                            ...
                                            <div class="col-12 col-sm-4 form-group form-group--lg">
                                                ...
                                                <div class="input-group input-group--append">
                                                    <select class="input js-input-select input--fluid" data-placeholder="Select Model" name="model" id="car_model">
                                            ...
                                            <div class="col-12 col-sm-4 form-group form-group--lg">
                                                ...
                                                <div class="input-group">
                                                    <input class="input" type="text" name="variant" id="variant" placeholder="model" value="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="add-product__submit">
                                            <div class="modal__footer-button">
                                                <input type="submit" name="submit" class="button button--primary button--block"  value="Add Variant">
                                            </div>
                ...
                <table class="table table--lines" id="">
                    ...
                    <thead class="table__header">
                        <tr class="table__header-row">
                            ...
                            <th class="d-sm-table-cell d-lg-table-cell"><span>Id</span>
                            </th>
                            ...
                            <th class="table__th-sort  d-sm-table-cell"><span class="align-middle">Variant</span><span class="sort sort--down"></span>
                            </th>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="table__row">
                                    ...
                                    <td class="make_items d-sm-table-cell table__td text-grey"><?php echo $row['variant']; ?>
                                    </td>
                                    <td class="table__td table__actions">
                                        <div class="items-more">
                                            <a class="items-more__button" href="./delete-exe/delete-variant.php?id=<?php echo $row['id']?>"">
