                                    ...
                                    <ul class="customer-details__list">
                                        <li>
                                            <div class="row row--xs justify-content-between">
                                                ...
                                                <div class="col-auto">Felecia</div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="row row--xs justify-content-between">
                                                <div class="col-auto text-grey">Last Name</div>
                                                <div class="col-auto">Burke</div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="row row--xs justify-content-between">
                                                <div class="col-auto text-grey">Date of Birth</div>
                                                <div class="col-auto">10 June, 1990</div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="row row--xs justify-content-between">
                                    ...
                                    <ul class="customer-shipping__list">
                                        ...
                                        <li>
                                            <div class="row row--xs justify-content-between">
                                                ...
                                                <div class="col-auto">Boston</div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="row row--xs justify-content-between">
                                                <div class="col-auto text-grey">Country</div>
                                                <div class="col-auto">United States</div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="row row--xs justify-content-between">
                                                <div class="col-auto text-grey">State</div>
                                                <div class="col-auto">Massachusetts</div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="row row--xs justify-content-between">
