        ...
        <main class="page-content">
            <div class="container">
                <div class="page-header">
                    <h1 class="page-header__title">Add Make</h1>
                </div>
                        ...
                        <div class="breadcrumbs">
                            <div class="breadcrumbs__container">
                                <ol class="breadcrumbs__list">
                                    ...
                                    <li class="breadcrumbs__item active"><span class="breadcrumbs__link">Add Make</span>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="card add-product card--content-center">
                    <div class="card__wrapper">
                        <div class="card__container">
                            <form class="add-product__form" method="POST" action="./execution/make-exe.php">
                                        ...
                                        <div class="row row--md">
                                            <div class="col-12 col-sm-6 form-group form-group--lg">
                                                ...
                                                <div class="input-group">
                                                    <input class="input" type="text" name="make" placeholder="" value="Apple Watch Series 4" required>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6 form-group form-group--lg align-items-center">
                                                <div class="add-product__submit make-submit ">
                                                    <div class="modal__footer-button">
                                                        <input class="button button--primary button--block" type="submit" name="submit" value="Add Make">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="table__row">
                                    ...
                                    <td contenteditable="true" class="make_items d-sm-table-cell table__td text-grey"><?php echo $row['make']; ?>
                                    </td>
