<?php $user_data = check_user_profile($_SESSION['user_id']); ?>
<header class="header">
            ...
            <div class="header__row row justify-content-between">
                ...
                <div class="header__col-right col d-flex align-items-center">
                    ...
                    <div class="header__profile dropdown">
                        ...
                        <div class="profile-dropdown dropdown-menu dropdown-menu--right"><a class="profile-dropdown__item dropdown-menu__item" href="./my-profile.php?id=<?php echo $_SESSION['user_id']; ?> " tabindex="0"><span class="profile-dropdown__icon">
...
<aside class="sidebar <?php if (!get_user_active_status($_SESSION['user_id'])) {
                            echo "deactivate_account";
                        } ?>">
    <div class="sidebar__backdrop"></div>
    <div class="sidebar__container">
        <div class="sidebar__top">
            <div class="container container--sm">
                <a class="sidebar__logo" href="user-dashboard.php">
        ...
        <div class="sidebar__content" data-simplebar="data-simplebar">
            <nav class="sidebar__nav">
                <ul class="sidebar__menu">
                    <li class="sidebar__menu-item"><a class="sidebar__link" href="user-dashboard.php" aria-expanded="false"><span class="sidebar__link-icon">
                                <svg class="icon-icon-dashboard">
                                    <use xlink:href="#icon-dashboard"></use>
                                </svg></span><span class="sidebar__link-text">Dashboard</span></a>
                    </li>
                    <li class="sidebar__menu-item"><a class="sidebar__link" href="user-add-listing.php" aria-expanded="false"><span class="sidebar__link-icon">
                                <svg class="icon-icon-calendar">
                                    <use xlink:href="#icon-calendar"></use>
                                </svg></span><span class="sidebar__link-text">Add Listing</span></a>
                    </li>
                    <li class="sidebar__menu-item"><a class="sidebar__link" href="user-listing.php" aria-expanded="false"><span class="sidebar__link-icon">
                                <svg class="icon-icon-calendar">
                                    <use xlink:href="#icon-calendar"></use>
                                </svg></span><span class="sidebar__link-text">Manage Listing</span></a>
                    </li>
                </ul>
            </nav>
        </div>
