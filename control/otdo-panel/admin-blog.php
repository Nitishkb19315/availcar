				...
				<div class="panel panel-default border-panel card-view">
					...
					<div class="panel-wrapper collapse in">
						<div class="panel-body">
							<div class="form-wrap">
								<form action="blog-exe.php" method="POST" enctype="multipart/form-data">
									<div class="row">
										<div class="col-sm-12">
								...
								<div class="table-responsive">
									<table id="datable_1" class="table table-hover display  pb-30" >
										...
										<tr>
										  ...
										  <td><img src="uploads/blog/<?php echo $row['filename'];?>" height="100px" width="100px"></td>
                      					  <td class="text-center"><a href="delete-blog.php?id=<?php echo $row['id']?>" class="text-red"><i class="zmdi zmdi-delete txt-danger txt-2x"></i></a></td>
										</tr> 
										<?php
										}
										}
